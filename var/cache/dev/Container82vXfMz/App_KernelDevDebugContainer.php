...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getFosRest_FormatListenerService()
    {
        ...
        $a->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/user', NULL, NULL, NULL, []), ['prefer_extension' => '2.0', 'fallback_format' => 'json', 'priorities' => [0 => 'json'], 'methods' => NULL, 'attributes' => [], 'stop' => false]);
